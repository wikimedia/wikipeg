...
function peg$parse(input, options = {}) {
  ...
  var peg$c18 = {"type":"other","description":"literal"};
  var peg$c19 = {"type":"other","description":"character class"};
  ...
  var peg$c23 = {"type":"class","value":"[0-9]","description":"[0-9]"};
  ...
  function peg$a6(sequence) {
   return sequence; 
  }
  function peg$a7() {
   return text(); 
  }
  function peg$a8(expression, code) {
  ...
  function peg$a25(value, ignoreCase) {
  ...
  function peg$a26(inverted, parts, ignoreCase) {
  ...
  function peg$a29(operator, code) {
  ...
  function peg$a30(operator, parameter) {
  ...
  function peg$a32(first, rest) {
  
        return [first].concat(rest);
      
  }
  function peg$a33(ampersand, name, assign) {
  ...
  function peg$parseRule(silence) {
    ...
    peg$discard__();
    r8 = peg$parseChoiceExpression(silence);
    // expression <- r8
    if (r8===peg$FAILED) {
      peg$currPos = p3;
      r1 = peg$FAILED;
