...
function peg$parse(input, options = {}) {
  ...
  function peg$parseDoubleStringCharacter(silence) {
    ...
    r5 = peg$parseEscapeSequence(silence);
    // sequence <- r5
    if (r5===peg$FAILED) {
      peg$currPos = p4;
      r1 = peg$FAILED;
  ...
  function peg$parseRuleReferenceExpression(silence) {
    var r1,p2,p3,r4,r5,p6,r7,p8,r9,r10,p11,r12,r13;
    p2 = peg$currPos;
    seq_1: {
    p3 = peg$currPos;
    r4 = peg$parseIdentifierName(silence);
