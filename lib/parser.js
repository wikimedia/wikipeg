...
function peg$parse(input, options = {}) {
  ...
  var peg$c23 = {"type":"other","description":"literal"};
  var peg$c24 = {"type":"other","description":"character class"};
  ...
  var peg$c28 = {"type":"class","value":"[0-9]","description":"[0-9]"};
  ...
  function peg$a21(label, ampersand, parameter) {
  ...
  function peg$a22(label, expression) {
  ...
  function peg$a23(operator, expression) {
  ...
  function peg$a24(name) {
   return name; 
  }
  function peg$a25(expression, operator) {
  ...
  function peg$a26(expression) {
   return expression; 
  }
  function peg$a27(value, ignoreCase) {
  ...
  function peg$a28(inverted, parts, ignoreCase) {
  ...
  function peg$a31(operator, code) {
  ...
  function peg$a32(operator, parameter) {
  ...
  function peg$a34(first, rest) {
  
        return buildList(first, rest, 3);
      
  }
  function peg$a35(ampersand, name, assign) {
  ...
  function peg$parseRule(silence) {
    ...
    seq_2: {
    p6 = peg$currPos;
    r7 = peg$parseStringLiteral(silence);
    if (r7===peg$FAILED) {
      r5 = peg$FAILED;
      break seq_2;
    }
    ...
    peg$discard__();
    r7 = peg$parseChoiceExpression(silence);
    // expression <- r7
    if (r7===peg$FAILED) {
      peg$currPos = p3;
      r1 = peg$FAILED;
  ...
  function peg$parseSequenceExpression(silence) {
    ...
    for (;;) {
      ...
      p7 = peg$currPos;
      r8 = peg$parse__(silence);
      r9 = peg$parsePickedSequenceElement(silence);
      if (r9===peg$FAILED) {
        peg$currPos = p7;
        r6 = peg$FAILED;
        break seq_2;
  ...
  function peg$parsePickedSequenceElement(silence) {
    ...
    p3 = peg$currPos;
    seq_2: {
    r5 = peg$parsePickedOperator(silence);
    if (r5===peg$FAILED) {
      r4 = peg$FAILED;
      break seq_2;
    }
    r6 = peg$parse__(silence);
    r4 = [r5,r6];
    } // seq_2
    if (r4===peg$FAILED) {
      r4 = null;
    ...
    // free r5,r6
    // p <- r4
    r6 = peg$parseSequenceElement(silence);
    // el <- r6
    if (r6===peg$FAILED) {
      peg$currPos = p3;
      r1 = peg$FAILED;
