...
ParameterPredicateExpression
  = operator:ParameterPredicateOperator __ "<" __ parameter:Identifier __ assert:( @EqualityOperator __ @ParameterValue __ )? ">" {
...
/* Accomodate folks who are used to using triple-equals */
EqualityOperator
  = @"==" "="?
  / @"!=" "="?
